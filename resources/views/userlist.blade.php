                        ...
                        <table id="userlist" class="table-bordered" width="100%" cellspacing="0">
                            ...
                            <tbody style="text-align:center;">
                                ...
                                <tr>
                                    ...
                                    <td>
                                    <a href="/userlist/edit/{{$row->id}}" target="_blank"><button class="btn btn-primary text-white">Edit</button></a>
                                        <a href="/userlist/delete/{{$row->id}}"><button class="btn btn-danger text-white">Delete</button></a>
                                    </td>
                                </tr>
                                @endforeach
                            </tbody>
